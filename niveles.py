...
titleNivel = base_font100.render("MAIN MENU", True, 'white')
textoNivel1 = base_font40.render("NIVEL 1", True, (189, 224, 177))
textoNivel2 = base_font40.render("NIVEL 2", True, (189, 224, 177))
textoNivel3 = base_font40.render("NIVEL 3", True, (189, 224, 177))
textoNivel4 = base_font40.render("NIVEL 4", True, (189, 224, 177))
textoNivel5 = base_font40.render("NIVEL 5", True, (189, 224, 177))
textoNivel6 = base_font40.render("NIVEL 6", True, (189, 224, 177))

textoCovid = base_font30.render("¿COVID-19...?", True, 'white')
textoConf = base_font30.render("CONFINAMIENTO", True, 'white')
textoRest = base_font30.render("RESTRICCIONES", True, 'white')
textoBye = base_font30.render("BYE ESTADO ALARMA", True, 'white')
...
def Niveles(user_text):
    ...
    while True:
        ...
        screen.blit(titleNivel, (280, 125))
        ...
        for e in pygame.event.get():
            ...
            if e.type == MOUSEBUTTONDOWN and e.button == 1:
                if nivel1.collidepoint(mouse.get_pos()):
                    # print("Hola 1")
                    game = Game(174, 173, 166, "murcielago.jpg", "pangolin-2.jpg", "snakeojos.jpg")
                    game.reset()
                    game.run(tiempo=0.40)
                elif nivel2.collidepoint(mouse.get_pos()):
                    # print("Hola 2")
                    game = Game(29, 173, 208, "papel2.jpg", "gel2.jpg", "snakeojos.jpg")
                    game.reset()
                    game.run(tiempo=0.30)
                elif nivel3.collidepoint(mouse.get_pos()):
                    # print("Hola 3")
                    game = Game(228, 162, 244, "teams3.jpg", "flour3.jpg", "snakeojosmask.jpg")
                    game.reset()
                    game.run(tiempo=0.25)
                elif nivel4.collidepoint(mouse.get_pos()):
                    # print("Hola 4")
                    game = Game(76, 114, 67, "bici4.jpg", "PCR4.jpg", "snakeojosmask.jpg")
                    game.reset()
                    game.run(tiempo=0.20)
                elif nivel5.collidepoint(mouse.get_pos()):
                    # print("Hola 5")
                    game = Game(242, 164, 58, "cerve5.jpg", "gin5.jpg", "snakeojos.jpg")
                    game.reset()
                    game.run(tiempo=0.15)
                elif nivel6.collidepoint(mouse.get_pos()):
                    # print("Hola 6")
                    game = Game(219, 114, 131, "vacuna6.jpg", "pill6.jpg", "snakeojosmask.jpg")
                    game.reset()
