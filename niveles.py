        ...
        for e in pygame.event.get():
            ...
            if e.type == MOUSEBUTTONDOWN and e.button == 1:
                if nivel1.collidepoint(mouse.get_pos()):
                    # print("Hola 1")
                    game = Game("corona193.jpg", "murcielago-3.png", "pangolin1-2.png", "kiss-2.png", "snakeojos.jpg")
                    game.reset()
                    game.run(tiempo=0.40)
                elif nivel2.collidepoint(mouse.get_pos()):
                    # print("Hola 2")
                    game = Game("casaoscura.jpg", "papelhigienico-2.png", "gelh-2.png", "kiss2.jpg", "snakeojos.jpg")
                    game.reset()
                    game.run(tiempo=0.30)
                elif nivel3.collidepoint(mouse.get_pos()):
                    # print("Hola 3")
                    game = Game("cocinaoscura.jpg", "teams-2.png", "harina-2.png", "party3.jpg", "snakeojosmask.jpg")
                    game.reset()
                    game.run(tiempo=0.25)
                elif nivel4.collidepoint(mouse.get_pos()):
                    # print("Hola 4")
                    game = Game("campo4byn.jpg", "bici-2.png", "mascarilla-2.png", "kiss-2.png", "snakeojosmask.jpg")
                    game.reset()
                    game.run(tiempo=0.20)
                elif nivel5.collidepoint(mouse.get_pos()):
                    # print("Hola 5")
                    game = Game("puertasolbyn2.jpg", "cerveza-2.png", "copita-2.png","kiss5.jpg", "snakeojos.jpg")
                    game.reset()
                    game.run(tiempo=0.15)
                elif nivel6.collidepoint(mouse.get_pos()):
                    # print("Hola 6")
                    game = Game("covid6.jpg", "vacun-2.png", "pill-3.png","party6.jpg", "snakeojosmask.jpg")
                    game.reset()
